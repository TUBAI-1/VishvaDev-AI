  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50">
      <div className="bg-white rounded-xl shadow-medical border border-gray-100 p-10 flex flex-col items-center">
        <h1 className="text-4xl font-bold text-medical-600 mb-4">VISHVADEV AI</h1>
        <p className="text-lg text-gray-700 mb-8 text-center max-w-xl">
          Welcome to VishvaDev AI! Experience 24/7 intelligent medical support using conversational AI. Triage symptoms, book appointments, and get expert advice from AI-powered specialist agents.
        </p>
